...
public class BookingServiceImpl implements BookingService {
	...
	public String bookSeatForAPassenger(Seat seat, String flightNumber, int userId) {
		Seat seat1 = seatRepository.findSingleSeatNumberWithLock(seat.getSeatNumber(), flightNumber);
//		Passenger passenger = passengerRepository.findById(userId).get();
...
//					s.setPassenger(passenger);
					seatResult = seatRepository.save(seat1);
//
...
//		}
		if (seatResult != null)
			return "Seat has been chosen and locked for 1 min";
		return null;
//	}
//		return "Seat has been locked";
	}
}
